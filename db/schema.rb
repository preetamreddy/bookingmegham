...
ActiveRecord::Schema.define(:version => 20170913021606) do
  ...
  create_table "price_lists", :force => true do |t|
    ...
    t.integer  "price_for_lodging_on_single",        :default => 0
    t.integer  "price_for_lodging_on_double",        :default => 0
  end
  ...
  create_table "rooms", :force => true do |t|
    ...
    t.integer  "discount",                                  :default => 0
    t.integer  "taxable_value",                             :default => 0
    t.integer  "lodging_rate",                              :default => 0
