class RoomObserver < ActiveRecord::Observer
	def after_create(room)
		...
		update_price_for_rooms_and_service_tax(room.booking_id, delta_discount, delta_taxable_value, delta_cgst, delta_sgst, delta_total_price)
	end
	...
	def update_price_for_rooms_and_service_tax(booking_id, delta_discount, delta_taxable_value, delta_cgst, delta_sgst, delta_total_price)
		if delta_discount != 0 or delta_taxable_value != 0 or delta_cgst != 0 or delta_cgst != 0 or delta_total_price != 0
