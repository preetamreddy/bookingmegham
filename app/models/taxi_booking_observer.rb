class TaxiBookingObserver < ActiveRecord::Observer
	def after_create(taxi_booking)
		...
		update_price_for_transport(taxi_booking.trip_id, delta_taxable_value, delta_cgst, delta_sgst, delta_total_price)
	...
	def update_price_for_transport(trip_id, delta_taxable_value, delta_cgst, delta_sgst, delta_total_price)
		if delta_taxable_value != 0 or delta_cgst != 0 or delta_sgst != 0 or delta_total_price != 0
