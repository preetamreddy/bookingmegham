class BookingObserver < ActiveRecord::Observer
	def after_create(booking)
		...
		update_price_and_service_tax(booking.trip_id, delta_discount, delta_taxable_value, delta_cgst, delta_cgst, 
	...
	def update_price_and_service_tax(trip_id, delta_discount, delta_taxable_value, delta_cgst, delta_sgst, 
				delta_price_for_vas, delta_price_for_rooms)
